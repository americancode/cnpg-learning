...
7. archive CNPG WAL to MinIO using integrated Barman object-store support
...
```bash
./demo-integrated-barman/crunchy-cnpg-migration/scripts/init-podman-machine.sh
./demo-integrated-barman/crunchy-cnpg-migration/scripts/init-cluster.sh
./demo-integrated-barman/crunchy-cnpg-migration/scripts/install-platform.sh
./demo-integrated-barman/crunchy-cnpg-migration/scripts/setup-namespace.sh
./demo-integrated-barman/crunchy-cnpg-migration/scripts/setup-storage.sh
./demo-integrated-barman/crunchy-cnpg-migration/scripts/deploy-crunchy-source.sh
./demo-integrated-barman/crunchy-cnpg-migration/scripts/seed-crunchy-source.sh
./demo-integrated-barman/crunchy-cnpg-migration/scripts/trigger-crunchy-backup.sh
./demo-integrated-barman/crunchy-cnpg-migration/scripts/deploy-cnpg-target.sh
./demo-integrated-barman/crunchy-cnpg-migration/scripts/verify-migration.sh
```
